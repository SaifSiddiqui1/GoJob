    ...
    return (
        <div className="space-y-4 animate-fade-in">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="font-heading text-2xl font-bold text-gray-900 dark:text-white">Job Finder</h1>
                    <p className="text-gray-500 text-sm mt-1">{pagination.total || 0} curated jobs available</p>
                </div>
